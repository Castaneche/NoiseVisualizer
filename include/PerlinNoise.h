...
public:
	...
	//1D
	double noise(double x, Interpolation method);
	double noise(double x, int octaves, double persistence, Interpolation method, std::vector<double>* intermediateValues = nullptr);
	
	//2D
	double noise(double x, double y, Interpolation method);
	double noise(double x, double y, int octaves, double persistence, Interpolation method, std::vector<double>* intermediateValues = nullptr);
...
private:
	...
	int* p; //Doubled permutation to avoid oveflow
